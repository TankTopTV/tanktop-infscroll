...
(function($) {
    ...
    function render_data(data, json, fixed_json) {
        ...
        if (data.settings.fewer_tiles && (data.moving_tiles.maxLoaded + data.fixed_tiles.maxLoaded < data.settings.fewer_tiles.limit)) {
        	...
        	var main_target = data.settings.fewer_tiles.target;
        	var fixed_target = data.settings.fewer_tiles.target;
        	var main_helpers = data.settings.fewer_tiles.helpers;
        	var fixed_helpers = data.settings.fewer_tiles.helpers;        	
        } else {
        	var main_target = data.moving_tiles.settings.target;
        	var fixed_target = data.fixed_tiles.settings.target;
        	var main_helpers = data.moving_tiles.settings.helpers;
        	var fixed_helpers = data.fixed_tiles.settings.helpers;        	        	
        }
        ...
        .done(function() {
            		...
            		if (container_pos) {
                		data.fixed_tiles.$target.css({"top": container_pos.top + "px", "left": container_pos.left + "px"});                			
            		}
